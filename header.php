...
<body>
	...
	<div class="container-fluid">
		<div class="header_top">
			...
			<span style="font-size:50px;color:#2c2f84;font-weight:bolder;margin-left:15px;"><marquee>E-HEALTHCARE</marquee></span>
			<img src="img/logo.jpg" height="100 px" position :absolute;
			top: 0px;
			left: 0px;
 >
