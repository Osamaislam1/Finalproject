 ...
 <!-- validation and insertion -->
			...
			<?php
						...
						if(isset($_POST['submit'])){
							...
							$sql = "INSERT INTO doctor (userid,name,address,contact,email,expertise,id,fee)
							VALUES ('" . $_POST["userid"] ."','" . $_POST["name"] . "','" . $_POST["address"] . "','" . $_POST["contact"] . "','" . $_POST["email"] . "', '" . $_POST["expertise"] . "','" . $_POST["userid"] . "','" . $_POST["fee"] . "' )";
